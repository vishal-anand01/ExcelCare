const selectors = [
  ...
  ".laundry-hero .laundry-hero__highlight",
  ".contact-page__hero .contact-page__highlight",
  ".laundry-trust-section .laundry-trust-section__highlight",
  ".laundry-types-section .laundry-types-section__highlight",
  ".expert-laundry-section .expert-laundry-section__highlight",
  ".doorstep-laundry-section .doorstep-laundry-section__highlight",
...
function replaySequence(target) {
  ...
  const timer = window.setInterval(() => {
    ...
    // Keep the completed underline on screen before starting the next typing pass.
    // Individual highlights can opt into a longer pause with data-underline-pause.
    const pause = Number.parseInt(target.dataset.underlinePause, 10) || 3300;
